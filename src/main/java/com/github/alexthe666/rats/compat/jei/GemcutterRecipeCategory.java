...
public class GemcutterRecipeCategory implements IRecipeCategory<GemcutterRecipe> {
	...
	public GemcutterRecipeCategory(IGuiHelper helper) {
		...
		this.icon = helper.createDrawableItemStack(new ItemStack(RatsItemRegistry.TINY_COIN.get()));
		this.arrow = helper.drawableBuilder(TEXTURE, 176, 0, 24, 16)
				.buildAnimated(200, IDrawableAnimated.StartDirection.LEFT, false);
	}

	@Override
	public RecipeType<GemcutterRecipe> getRecipeType() {
		return RatsRecipeTypes.GEMCUTTER;
	}
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, GemcutterRecipe recipe, IFocusGroup ingredients) {
