...
public class RatlantisFeatureRegistry {
	public static final DeferredRegister<WorldCarver<?>> CARVERS = DeferredRegister.create(NeoForgeRegistries.WORLD_CARVERS, RatsMod.MODID);
	public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(NeoForgeRegistries.FEATURES, RatsMod.MODID);
