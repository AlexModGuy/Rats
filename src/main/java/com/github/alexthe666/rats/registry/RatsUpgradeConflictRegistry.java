...
//TODO migrate away from this. We need a better system here that works with combined upgrades as well
@Deprecated
public class RatsUpgradeConflictRegistry {
	...
	public static void init() {
		...
		REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_CHEF.get(), PROCESSING_CONFLICTS);
		REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_CRAFTING.get(), PROCESSING_CONFLICTS);
