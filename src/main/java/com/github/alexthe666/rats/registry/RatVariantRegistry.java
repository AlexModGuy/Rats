...
public class RatVariantRegistry {
	...
	// Create the actual registry using RegistryBuilder
	public static final Registry<RatVariant> RAT_VARIANT_REGISTRY = new RegistryBuilder<>(RAT_VARIANT_KEY)
			.sync(true)
			.create();
	
	public static final DeferredRegister<RatVariant> RAT_VARIANTS = DeferredRegister.create(RAT_VARIANT_REGISTRY, RatsMod.MODID);

	public static Registry<RatVariant> getRegistry() {
		return RAT_VARIANT_REGISTRY;
	}
