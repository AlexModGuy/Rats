...
public class RatlantisEntityRegistry {
	...
	public static final RegistryObject<EntityType<RatlanteanSpirit>> RATLANTEAN_SPIRIT = registerEntity("ratlantean_spirit", EntityType.Builder.of(RatlanteanSpirit::new, MobCategory.MONSTER).fireImmune().sized(1.25F, 1.25F), 0XEDBD00, 0XFFE8AF);
	...
	public static final RegistryObject<EntityType<FeralRatlantean>> FERAL_RATLANTEAN = registerEntity("feral_ratlantean", EntityType.Builder.of(FeralRatlantean::new, MobCategory.MONSTER).sized(1.85F, 1.2F), 0X30333E, 0XECECEC);
