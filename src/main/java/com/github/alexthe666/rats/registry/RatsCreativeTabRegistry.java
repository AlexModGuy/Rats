...
public class RatsCreativeTabRegistry {
	...
	@SubscribeEvent
	public static void registerRatsTabs(CreativeModeTabEvent.Register event) {
		CreativeModeTab ITEMS = event.registerCreativeModeTab(new ResourceLocation(RatsMod.MODID, "rats"), builder -> builder
		...
		CreativeModeTab UPGRADES = event.registerCreativeModeTab(new ResourceLocation(RatsMod.MODID, "rats_upgrades"), List.of(), List.of(ITEMS), builder -> builder
		...
		event.registerCreativeModeTab(new ResourceLocation(RatsMod.MODID, "ratlantis"), List.of(), List.of(UPGRADES), builder -> builder
