...
import com.github.alexthe666.rats.server.misc.RatsArmorMaterial;
...
public class RatsItemRegistry {
	...
	public static final RegistryObject<Item> CHEF_TOQUE = ITEMS.register("chef_toque", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.CHEF_TOQUE, 0));
	public static final RegistryObject<Item> PIPER_HAT = ITEMS.register("piper_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.PIPER_HAT, 1));
	...
	public static final RegistryObject<Item> ARCHEOLOGIST_HAT = ITEMS.register("archeologist_hat", () -> new HatItem(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON), RatsArmorMaterial.GENERIC_HAT, 1));
	public static final RegistryObject<Item> FARMER_HAT = ITEMS.register("farmer_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.FARMER_HAT, 0));
	public static final RegistryObject<Item> FISHERMAN_HAT = ITEMS.register("fisherman_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.GENERIC_HAT, 0));
	public static final RegistryObject<Item> RAT_FEZ = ITEMS.register("rat_fez", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.FEZ, 2));
	public static final RegistryObject<Item> TOP_HAT = ITEMS.register("top_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.TOP_HAT, 0));
	public static final RegistryObject<Item> SANTA_HAT = ITEMS.register("santa_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.SANTA_HAT, 0));
	public static final RegistryObject<Item> HALO_HAT = ITEMS.register("halo_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.HALO, 0));
	...
	public static final RegistryObject<Item> PIRAT_HAT = ITEMS.register("pirat_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.GENERIC_HAT, 0));
	public static final RegistryObject<Item> RAT_KING_CROWN = ITEMS.register("rat_king_crown", () -> new HatItem(new Item.Properties().stacksTo(1).rarity(Rarity.RARE), RatsArmorMaterial.CROWN, 0));
	public static final RegistryObject<Item> PLAGUE_DOCTOR_MASK = ITEMS.register("plague_doctor_mask", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.PLAGUE_MASK, 1));
	public static final RegistryObject<Item> BLACK_DEATH_MASK = ITEMS.register("black_death_mask", () -> new HatItem(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.RARE), RatsArmorMaterial.PLAGUE_MASK, 1));
	public static final RegistryObject<Item> EXTERMINATOR_HAT = ITEMS.register("exterminator_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.GENERIC_HAT, 0));
