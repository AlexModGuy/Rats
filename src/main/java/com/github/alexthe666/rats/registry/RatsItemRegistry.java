...
public class RatsItemRegistry {
	...
	public static final DeferredHolder<Item, Item> STRING_CHEESE = ITEMS.register("string_cheese", () -> new LoreTagItem(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.4F).build()), 1));
	...
	public static final DeferredHolder<Item, Item> MUSIC_DISC_MICE_ON_VENUS = ITEMS.register("music_disc_mice_on_venus", () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(RatsJukeboxSongRegistry.MICE_ON_VENUS)));
	public static final DeferredHolder<Item, Item> MUSIC_DISC_LIVING_MICE = ITEMS.register("music_disc_living_mice", () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(RatsJukeboxSongRegistry.LIVING_MICE)));
