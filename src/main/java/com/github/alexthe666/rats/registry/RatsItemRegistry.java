...
public class RatsItemRegistry {
	...
	public static final RegistryObject<Item> RAT_UPGRADE_REMEDY = ITEMS.register("rat_upgrade_remedy", () -> new StatBoostingRatUpgradeItem(new Item.Properties(), 2, 1, Map::of, true));
	...
	public static final RegistryObject<Item> RAT_UPGRADE_SUPPORT = ITEMS.register("rat_upgrade_support", () -> new SupportRatUpgradeItem(new Item.Properties()));
