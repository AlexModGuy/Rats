...
public class RatsBlockRegistry {
	...
	public static final DeferredHolder<Block, Block> MANHOLE = register("manhole", () -> new TrapDoorBlock(Block.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops().strength(10.0F).sound(SoundType.ANVIL).noOcclusion(), BlockSetType.IRON));
