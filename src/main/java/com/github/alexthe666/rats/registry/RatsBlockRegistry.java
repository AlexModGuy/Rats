...
public class RatsBlockRegistry {
	...
	public static final RegistryObject<Block> RAT_HOLE = register("rat_hole", () -> new RatHoleBlock(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).noOcclusion().dynamicShape().strength(1.3F, 0.0F)));
	...
	public static final RegistryObject<Block> RAT_CAGE_DECORATED = register("rat_cage_decorated", () -> new RatCageDecoratedBlock(Block.Properties.copy(RAT_CAGE.get())));
	public static final RegistryObject<Block> RAT_CAGE_BREEDING_LANTERN = register("rat_cage_breeding_lantern", () -> new RatCageBreedingLanternBlock(Block.Properties.copy(RAT_CAGE.get())));
	public static final RegistryObject<Block> RAT_CAGE_WHEEL = register("rat_cage_wheel", () -> new RatCageWheelBlock(Block.Properties.copy(RAT_CAGE.get())));
	...
	public static final RegistryObject<Block> RAT_TUBE_COLOR = register("rat_tube", () -> new RatTubeBlock(Block.Properties.of(Material.GLASS).sound(SoundType.WOOD).strength(0.9F, 0.0F)));
