...
public class RatsBlockRegistry {
	...
	public static final DeferredHolder<Block, Block> RAT_TRAP = register("rat_trap", () -> new RatTrapBlock(Block.Properties.of().sound(SoundType.WOOD).noCollission().strength(1.0F, 0.0F)));
	public static final DeferredHolder<Block, Block> RAT_TUBE_COLOR = BLOCKS.register("rat_tube", () -> new RatTubeBlock(Block.Properties.of().sound(SoundType.WOOD).strength(0.9F, 0.0F)));
	...
	public static final DeferredHolder<Block, Block> BLOCK_OF_NETHER_CHEESE = register("block_of_nether_cheese", () -> new Block(Block.Properties.of().strength(0.6F, 0.0F).sound(SoundType.SLIME_BLOCK)));
	public static final DeferredHolder<Block, Block> PIED_WOOL = register("pied_wool", () -> new Block(Block.Properties.of().strength(1.0F, 0.0F).sound(SoundType.WOOL)));
	public static final DeferredHolder<Block, Block> UPGRADE_COMBINER = register("upgrade_combiner", () -> new UpgradeCombinerBlock(Block.Properties.of().sound(SoundType.WOOD).requiresCorrectToolForDrops().noOcclusion().strength(5.0F, 0.0F).lightLevel(value -> 4)));
	public static final DeferredHolder<Block, Block> UPGRADE_SEPARATOR = register("upgrade_separator", () -> new UpgradeSeparatorBlock(Block.Properties.of().sound(SoundType.WOOD).requiresCorrectToolForDrops().noOcclusion().strength(5.0F, 0.0F).lightLevel(value -> 4)));
	public static final DeferredHolder<Block, Block> MANHOLE = register("manhole", () -> new TrapDoorBlock(BlockSetType.IRON, Block.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops().strength(10.0F).sound(SoundType.ANVIL).noOcclusion()));
	...
	public static final DeferredHolder<Block, Block> RAT_ATTRACTOR = register("rat_attractor", () -> new RatAttractorBlock(Block.Properties.of().sound(SoundType.LANTERN).requiresCorrectToolForDrops().noOcclusion().randomTicks().strength(1.0F, 0.0F)));
	public static final DeferredHolder<Block, Block> RAT_QUARRY = register("rat_quarry", () -> new RatQuarryBlock(Block.Properties.of().sound(SoundType.SLIME_BLOCK).strength(2.0F, 0.0F)));
	public static final DeferredHolder<Block, Block> RAT_QUARRY_PLATFORM = register("rat_quarry_platform", () -> new RatQuarryPlatformBlock(Block.Properties.of().sound(SoundType.SLIME_BLOCK).noOcclusion().strength(1.0F, 0.0F)));
