...
public class RatlantisItemRegistry {
	...
	public static final RegistryObject<Item> AVIATOR_HAT = ITEMS.register("aviator_hat", () -> new HatItem(new Item.Properties(), RatsArmorMaterial.GENERIC_HAT, 0));
	...
	public static final RegistryObject<ArmorItem> RATLANTIS_HELMET = ITEMS.register("ratlantis_helmet", () -> new RatlantisArmorItem(RatsArmorMaterial.RATLANTIS, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<ArmorItem> RATLANTIS_CHESTPLATE = ITEMS.register("ratlantis_chestplate", () -> new RatlantisArmorItem(RatsArmorMaterial.RATLANTIS, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<ArmorItem> RATLANTIS_LEGGINGS = ITEMS.register("ratlantis_leggings", () -> new RatlantisArmorItem(RatsArmorMaterial.RATLANTIS, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<ArmorItem> RATLANTIS_BOOTS = ITEMS.register("ratlantis_boots", () -> new RatlantisArmorItem(RatsArmorMaterial.RATLANTIS, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> GHOST_PIRAT_HAT = ITEMS.register("ghost_pirat_hat", () -> new HatItem(new Item.Properties().stacksTo(1).fireResistant(), RatsArmorMaterial.GHOST_HAT, 0));
	...
	public static final RegistryObject<Item> MILITARY_HAT = ITEMS.register("military_hat", () -> new HatItem(new Item.Properties().stacksTo(1), RatsArmorMaterial.GENERIC_HAT, 0));
