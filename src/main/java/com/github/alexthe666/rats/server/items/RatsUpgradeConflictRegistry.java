...
public class RatsUpgradeConflictRegistry {
    ...
    public static void init() {
        ...
        REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_CHEF, PROCESSING_CONFLICTS);
        REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_GEMCUTTER, PROCESSING_CONFLICTS);
        REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_ARCHEOLOGIST, PROCESSING_CONFLICTS);
        ...
        REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_ENCHANTER, PROCESSING_CONFLICTS);
        REGISTERED_CONFLICTS.put(RatsItemRegistry.RAT_UPGRADE_DISENCHANTER, PROCESSING_CONFLICTS);
