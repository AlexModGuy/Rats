...
public class EntityRatlanteanFlame extends AbstractFireballEntity {
    ...
    public EntityRatlanteanFlame(World worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ) {
        super(RatlantisEntityRegistry.RATLANTEAN_FLAME, shooter.getPosX(), shooter.getPosY() + shooter.getHeight() * 0.5D, shooter.getPosZ(), accelX, accelY, accelZ, worldIn);
    }
    ...
    public EntityRatlanteanFlame(FMLPlayMessages.SpawnEntity spawnEntity, World world) {
        this(RatlantisEntityRegistry.RATLANTEAN_FLAME, world);
    }
    ...
    public ItemStack getItem() {
        return new ItemStack(RatlantisItemRegistry.RATLANTEAN_FLAME);
    }
