...
public class BlackDeathSummonBeastGoal extends BlackDeathAbstractSummonGoal {
	...
	public void summonEntity() {
		...
		EventHooks.onFinalizeSpawn(beast, (ServerLevelAccessor) this.death.level(), this.death.level().getCurrentDifficultyAt(this.death.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null);
