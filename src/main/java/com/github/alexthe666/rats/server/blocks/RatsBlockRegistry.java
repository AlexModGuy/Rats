...
public class RatsBlockRegistry {
    ...
    public static final Block PIRAT_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_planks");
    public static final Block PIRAT_LOG = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_log");
    public static final Block STRIPPED_PIRAT_LOG = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("rats:stripped_pirat_log");
    public static final Block PIRAT_WOOD = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_wood");
    public static final Block STRIPPED_PIRAT_WOOD = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("rats:stripped_pirat_wood");
    public static final Block PIRAT_PRESSURE_PLATE = new BlockGenericPressurePlate(PressurePlateBlock.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_pressure_plate");
    public static final Block PIRAT_TRAPDOOR = new BlockGenericTrapDoor(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_trapdoor");
    ...
    public static final Block PIRAT_BUTTON = new BlockGenericButton(Block.Properties.create(Material.MISCELLANEOUS).func_235838_a_((p) -> 3).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_button");
    public static final Block PIRAT_SLAB = new SlabBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_slab");
    public static final Block PIRAT_FENCE_GATE = new FenceGateBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_fence_gate");
    public static final Block PIRAT_FENCE = new FenceBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_fence");
    public static final Block PIRAT_DOOR = new BlockGenericDoor(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).func_235838_a_((p) -> 3).hardnessAndResistance(3.0F).sound(SoundType.WOOD)).setRegistryName("rats:pirat_door");
