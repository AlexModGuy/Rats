...
public class EntityRatBiplaneMount extends EntityRatMountBase {
    ...
    public EntityRatBiplaneMount(EntityType<? extends MobEntity> type, World worldIn) {
        super(type, worldIn);
        this.riderY = 1.35F;
        this.riderXZ = -0.35F;
        this.stepHeight = 1.0F;
        this.upgrade = RatlantisItemRegistry.RAT_UPGRADE_BIPLANE_MOUNT;
        ...
        if (this.getAttackTarget() != null && this.canEntityBeSeen(this.getAttackTarget())) {
            ...
            if (this.ticksExisted % 2 == 0) {
                for (int i = 0; i < 2; i++) {
                    ...
                    double d2 = d0 - extraY;
                    float velocity = 3.2F;
                    EntityRattlingGunBullet cannonball = new EntityRattlingGunBullet(RatlantisEntityRegistry.RATTLING_GUN_BULLET, world, this);
