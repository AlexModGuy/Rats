...
public class EntityRattlingGun extends MobEntity implements IRatlantean, IPirat {
    ...
    public void shoot(EntityRat pirat) {
        ...
        if (target != null) {
            ...
            EntityRattlingGunBullet cannonball = new EntityRattlingGunBullet(RatlantisEntityRegistry.RATTLING_GUN_BULLET, world, pirat);
            float radius = 1.6F;
    ...
    public EntityRattlingGun(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn) {
        this(RatlantisEntityRegistry.RATTLING_GUN, worldIn);
    }
