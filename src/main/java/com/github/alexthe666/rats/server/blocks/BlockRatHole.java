...
public class BlockRatHole extends ContainerBlock implements IUsesTEISR {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        return super.getStateForPlacement(context).with(NORTH, Boolean.valueOf(this.canFenceConnectTo(blockstate, false, Direction.SOUTH))).with(EAST, Boolean.valueOf(this.canFenceConnectTo(blockstate1, false, Direction.WEST))).with(SOUTH, Boolean.valueOf(this.canFenceConnectTo(blockstate2, false, Direction.NORTH))).with(WEST, Boolean.valueOf(this.canFenceConnectTo(blockstate3, false, Direction.EAST)));
    }
    ...
    private boolean canFenceConnectTo(BlockState p_220111_1_, boolean p_220111_2_, Direction p_220111_3_) {
        ...
        return !cannotAttach(block) && block != this;
    }
