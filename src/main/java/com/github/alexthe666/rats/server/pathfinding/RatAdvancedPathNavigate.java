...
public class RatAdvancedPathNavigate extends AbstractAdvancedPathNavigate {
     ...
     */
    public RatAdvancedPathNavigate(final MobEntity entity, final World world) {
        super(entity, world);
    ...
    public PathResult setPathJob(
        ...
        if (speedFactor > MAX_SPEED_ALLOWED || speedFactor < MIN_SPEED_ALLOWED) {
            RatsMod.LOGGER.error("Tried to set a bad speed:" + speedFactor + " for entity:" + ourEntity, new Exception());
            return null;
        }
