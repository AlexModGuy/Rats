        ...
        if (!world.isRemote && this.getAttackTarget() != null) {
            ...
            if (attackSelection == 0 && summonCooldown == 0) {
                ...
                for (int i = 0; i < rand.nextInt(3) + 3; i++) {
                    EntityLaserPortal laserPortal = new EntityLaserPortal(RatlantisEntityRegistry.LASER_PORTAL, world, entity.getPosX() + this.rand.nextInt(bounds * 2) - bounds, this.getPosY() + 2, entity.getPosZ() + this.rand.nextInt(bounds * 2) - bounds, this);
