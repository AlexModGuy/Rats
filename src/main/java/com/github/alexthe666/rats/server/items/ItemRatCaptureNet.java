...
public class ItemRatCaptureNet  extends Item {

    public ItemRatCaptureNet() {
        super();
        this.setCreativeTab(RatsMod.TAB);
        this.setTranslationKey("rats.rat_capture_net");
        this.setRegistryName(RatsMod.MODID, "rat_capture_net");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityRatCaptureNet entitypotion = new EntityRatCaptureNet(worldIn, playerIn, itemstack1);
