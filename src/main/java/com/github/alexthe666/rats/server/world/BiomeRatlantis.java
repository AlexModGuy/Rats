...
public class BiomeRatlantis extends Biome {
    ...
    public BiomeRatlantis() {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.BUSH, new BushConfig(RatsBlockRegistry.RATGLOVE_FLOWER.getDefaultState()), Placement.CHANCE_HEIGHTMAP_DOUBLE, new ChanceConfig(14)));
