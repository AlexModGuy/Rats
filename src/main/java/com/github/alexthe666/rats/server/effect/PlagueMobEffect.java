...
public class PlagueMobEffect extends MobEffect {
	...
	public void addAttributeModifiers(AttributeMap attributes, int amplifier) {
		// Note: Sound and packet sending moved elsewhere - LivingEntity no longer available here
		super.addAttributeModifiers(attributes, amplifier);
	}

	@Override
	public void removeAttributeModifiers(AttributeMap attributes) {
		// Note: Packet sending moved elsewhere - LivingEntity no longer available here
