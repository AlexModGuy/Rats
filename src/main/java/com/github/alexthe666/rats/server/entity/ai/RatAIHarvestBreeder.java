...
public class RatAIHarvestBreeder extends Goal {
    ...
    public void tick() {
        if (this.targetSheep != null && this.targetSheep.isAlive() && !this.entity.getHeldItemMainhand().isEmpty()) {
            ...
            if (entity.getDistance(targetSheep) < 4.5D * this.entity.getRatDistanceModifier()) {
    ...
    private void resetTarget() {
        ...
        List<LivingEntity> list = this.entity.world.<LivingEntity>getEntitiesWithinAABB(LivingEntity.class, bb, (com.google.common.base.Predicate<? super LivingEntity>) perRatPredicate);
