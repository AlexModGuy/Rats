    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer player, EnumHand hand) {
        ...
        if(itemStackIn.getTagCompound() != null) {
            ...
            if (player.isSneaking()) {
                ...
                List<Entity> list = worldIn.<EntityRat>getEntitiesWithinAABBExcludingEntity(player, (new AxisAlignedBB(player.posX, player.posY, player.posZ, player.posX + 1.0D, player.posY + 1.0D, player.posZ + 1.0D)).grow(chunksize, 256, chunksize));
