	...
	static {
		PLAGUE_DOCTOR_TRADES = createTrades(ImmutableMap.of(1,
				new VillagerTrades.ItemListing[]{
						new EmeraldForItems(RatsItemRegistry.RAW_RAT.get(), 10, 1, 3),
						new ItemsForEmeralds(Items.BONE, 3, 8, 9, 1),
						new ItemsForEmeralds(Items.ROTTEN_FLESH, 2, 10, 9, 2),
						new EmeraldForItems(Items.POISONOUS_POTATO, 1, 3, 15),
						new EmeraldForItems(RatsItemRegistry.PLAGUE_ESSENCE.get(), 3, 3, 15),
						new EmeraldForItems(RatsItemRegistry.CONTAMINATED_FOOD.get(), 1, 1, 3),
						new ItemsForEmeralds(RatsItemRegistry.COOKED_RAT.get(), 1, 5, 15, 10),
						new ItemsAndEmeraldsToItems(Blocks.POPPY.asItem(), 5, 3, RatsItemRegistry.HERB_BUNDLE.get(), 3, 1, 5),
						new ItemsForEmeralds(RatsBlockRegistry.DYE_SPONGE.get(), 1, 1, 4, 4),
						new ItemsForEmeralds(RatsItemRegistry.TREACLE.get(), 2, 3, 10, 5),
						new ItemsForEmeralds(RatsBlockRegistry.GARBAGE_PILE.get(), 5, 4, 5, 3),
						new ItemsForEmeralds(RatsBlockRegistry.RAT_CAGE.get(), 2, 4, 4, 5),
						new ItemsForEmeralds(RatsItemRegistry.PLAGUE_DOCTOR_MASK.get(), 15, 1, 2, 10),
						new ItemsForEmeralds(RatsItemRegistry.RAT_SKULL.get(), 3, 1, 15, 10),
				},
				//Only 3 of these appear per plague doctor
				2, new VillagerTrades.ItemListing[]{
						new ItemsForEmeralds(RatsItemRegistry.PLAGUE_LEECH.get(), 3, 1, 15, 6),
						new ItemsForEmeralds(RatsItemRegistry.PLAGUE_STEW.get(), 7, 1, 8, 6),
						new ItemsForEmeralds(RatsItemRegistry.RAT_SACK.get(), 2, 1, 2, 5),
						new ItemsForEmeralds(RatsItemRegistry.PURIFYING_LIQUID.get(), 8, 1, 5, 7),
						new ItemsForEmeralds(RatsItemRegistry.TOKEN_FRAGMENT.get(), 3, 1, 20, 2),
						new ItemsForEmeralds(RatsItemRegistry.RAT_UPGRADE_BASIC.get(), 4, 2, 6, 10),
