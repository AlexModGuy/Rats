...
public class ChunkProviderRatlantis  extends NoiseChunkGenerator<OverworldGenSettings> {
    ...
    public ChunkProviderRatlantis(IWorld worldIn, BiomeProvider provider, OverworldGenSettings settingsIn) {
