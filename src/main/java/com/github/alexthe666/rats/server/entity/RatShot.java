...
public class RatShot extends ThrowableProjectile {
	...
	protected void defineSynchedData() {
		this.getEntityData().define(RAT_COLOR, RatVariants.getVariantId(RatVariants.getRandomVariant(this.random, false)));
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putString("RatColor", RatVariants.getVariantId(this.getColorVariant()));
	}

	public void readAdditionalSaveData(CompoundTag compound) {
		super.readAdditionalSaveData(compound);
		this.setColorVariant(RatVariants.getVariant(compound.getString("RatColor")));
	}
	...
	public RatVariant getColorVariant() {
		return RatVariants.getVariant(this.getEntityData().get(RAT_COLOR));
	}

	public void setColorVariant(RatVariant variant) {
		this.getEntityData().set(RAT_COLOR, RatVariants.getVariantId(variant));
	}
