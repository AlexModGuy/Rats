...
public class ItemRatlantisBow extends BowItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.rats.ratlantis_bow0.desc").applyTextStyle(TextFormatting.YELLOW));
        tooltip.add(new TranslationTextComponent("item.rats.ratlantis_bow1.desc").applyTextStyle(TextFormatting.GRAY));
    }
