...
public class RatbotAIStrife extends Goal {

    private final EntityRatlanteanRatbot entity;
    ...
    public RatbotAIStrife(EntityRatlanteanRatbot mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
        this.entity = mob;
