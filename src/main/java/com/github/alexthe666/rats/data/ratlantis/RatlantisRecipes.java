...
public class RatlantisRecipes extends RecipeProvider {
	...
	protected void buildRecipes(RecipeOutput output) {
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), 9)
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "oratchalcum_ingots_from_block"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatlantisItemRegistry.GHOST_PIRAT_ECTOPLASM.get(), 4)
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "ectoplasm_from_hat"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatlantisItemRegistry.GHOST_PIRAT_ECTOPLASM.get(), 4)
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "ectoplasm_from_cutlass"));


		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatlantisItemRegistry.GHOST_PIRAT_ECTOPLASM.get(), 10)
				.requires(RatlantisItemRegistry.DUTCHRAT_WHEEL.get()).unlockedBy("has_wheel", has(RatlantisItemRegistry.DUTCHRAT_WHEEL.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "ectoplasm_from_wheel"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, RatlantisBlockRegistry.PIRAT_PLANKS.get(), 4)
				...
				.group("planks")
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "pirat_planks_from_log"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get(), 4)
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_ratlantis_upgrade_from_block"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_COMBINED.get())
				...
				.define('G', RatlantisItemTags.RATLANTIS_GEMS).unlockedBy("has_gem", has(RatlantisItemTags.RATLANTIS_GEMS))
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/combined_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_ARCHEOLOGIST.get())
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/archeologist_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_AUTOMATON_MOUNT.get())
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/automaton_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_BIPLANE_MOUNT.get())
				...
				.define('W', RatlantisItemRegistry.BIPLANE_WING.get()).unlockedBy("has_wing", has(RatlantisItemRegistry.BIPLANE_WING.get()))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/biplane_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get())
				...
				.define('G', RatlantisItemTags.RATLANTIS_GEMS).unlockedBy("has_gem", has(RatlantisItemTags.RATLANTIS_GEMS))
				.define('M', RatsItemTags.MARBLED_CHEESE).unlockedBy("has_cheese", has(RatsItemTags.MARBLED_CHEESE))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_ratlantean_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_FERAL_BITE.get())
				...
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/feral_bite_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_BUCCANEER.get())
				...
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/buccaneer_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_RATINATOR.get())
				...
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/ratinator_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_PSYCHIC.get())
				...
				.pattern("CBC")
				.pattern("PUP")
				.define('S', Tags.Items.GEMS_PRISMARINE).unlockedBy("has_shard", has(Tags.Items.GEMS_PRISMARINE))
				...
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/psychic_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_ETHEREAL.get())
				...
				.define('U', RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()).unlockedBy("has_upgrade", has(RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get()))
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/ethereal_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatlantisItemRegistry.RAT_UPGRADE_NONBELIEVER.get())
				...
				.save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/nonbeliever_upgrade"));

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatsBlockRegistry.MARBLED_CHEESE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, RatlantisBlockRegistry.MARBLED_CHEESE.get(), 0.1F, 200).unlockedBy("has_cheese", has(RatsBlockRegistry.MARBLED_CHEESE_RAW.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "marble_cheese_smelting"));
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RecipeCategory.BUILDING_BLOCKS, RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CRACKED.get(), 0.1F, 200).unlockedBy("has_cheese", has(RatlantisBlockRegistry.MARBLED_CHEESE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "cracked_marble_cheese_smelting"));

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatlantisBlockRegistry.CHEESE_ORE.get()), RecipeCategory.MISC, RatsItemRegistry.CHEESE.get(), 0.25F, 200).unlockedBy("has_ore", has(RatlantisBlockRegistry.CHEESE_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "cheese_ore_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(RatlantisBlockRegistry.CHEESE_ORE.get()), RecipeCategory.MISC, RatsItemRegistry.CHEESE.get(), 0.25F, 100).unlockedBy("has_ore", has(RatlantisBlockRegistry.CHEESE_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "cheese_ore_blasting"));

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatlantisBlockRegistry.RATLANTEAN_GEM_ORE.get()), RecipeCategory.MISC, RatlantisItemRegistry.GEM_OF_RATLANTIS.get(), 0.5F, 200).unlockedBy("has_ore", has(RatlantisBlockRegistry.RATLANTEAN_GEM_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "ratlantean_gem_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(RatlantisBlockRegistry.RATLANTEAN_GEM_ORE.get()), RecipeCategory.MISC, RatlantisItemRegistry.GEM_OF_RATLANTIS.get(), 0.5F, 100).unlockedBy("has_ore", has(RatlantisBlockRegistry.RATLANTEAN_GEM_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "ratlantean_gem_blasting"));

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatlantisBlockRegistry.ORATCHALCUM_ORE.get()), RecipeCategory.MISC, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), 1.0F, 200).unlockedBy("has_ore", has(RatlantisBlockRegistry.ORATCHALCUM_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "oratchalcum_ore_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(RatlantisBlockRegistry.ORATCHALCUM_ORE.get()), RecipeCategory.MISC, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), 1.0F, 100).unlockedBy("has_ore", has(RatlantisBlockRegistry.ORATCHALCUM_ORE.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "oratchalcum_ore_blasting"));

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(RatlantisItemRegistry.RAW_ORATCHALCUM.get()), RecipeCategory.MISC, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), 1.0F, 200).unlockedBy("has_ore", has(RatlantisItemRegistry.RAW_ORATCHALCUM.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "raw_oratchalcum_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(RatlantisItemRegistry.RAW_ORATCHALCUM.get()), RecipeCategory.MISC, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), 1.0F, 100).unlockedBy("has_ore", has(RatlantisItemRegistry.RAW_ORATCHALCUM.get())).save(output, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "raw_oratchalcum_blasting"));

		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.BLACK_MARBLED_CHEESE.get(), "marbled_cheese_to_black");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_SLAB.get(), 2, "marbled_cheese_to_slab");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_STAIRS.get(), "marbled_cheese_to_stairs");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_CHISELED.get(), "marbled_cheese_to_chiseled");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_PILLAR.get(), "marbled_cheese_to_pillar");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_TILE.get(), "marbled_cheese_to_tile");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK.get(), "marbled_cheese_to_brick");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_SLAB.get(), 2, "marbled_cheese_to_brick_slab");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_STAIRS.get(), "marbled_cheese_to_brick_stairs");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CHISELED.get(), "marbled_cheese_to_brick_chiseled");

		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_SLAB.get(), 2, "marbled_cheese_brick_to_slab");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_STAIRS.get(), "marbled_cheese_brick_to_stairs");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CHISELED.get(), "marbled_cheese_brick_to_chiseled");

		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CRACKED.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CRACKED_SLAB.get(), 2, "cracked_marbled_cheese_brick_to_slab");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CRACKED.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_CRACKED_STAIRS.get(), "cracked_marbled_cheese_brick_to_stairs");

		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_MOSSY.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_MOSSY_SLAB.get(), 2, "mossy_marbled_cheese_brick_to_slab");
		this.ratlantisStonecuttingRecipe(output, Ingredient.of(RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_MOSSY.get()), RatlantisBlockRegistry.MARBLED_CHEESE_BRICK_MOSSY_STAIRS.get(), "mossy_marbled_cheese_brick_to_stairs");

		this.archeology(Items.EMERALD, RatlantisItemRegistry.GEM_OF_RATLANTIS.get(), output);
		this.archeology(RatsItemRegistry.RAT_UPGRADE_BASIC.get(), RatlantisItemRegistry.RAT_UPGRADE_BASIC_RATLANTEAN.get(), output);
		this.archeology(RatsItemRegistry.PIPER_HAT.get(), RatsItemRegistry.PIRAT_HAT.get(), output);
		this.archeology(Items.BLAZE_POWDER, RatlantisItemRegistry.RATLANTEAN_FLAME.get(), output);
		this.archeology(Items.LEATHER_CHESTPLATE, RatlantisItemRegistry.RAT_TOGA.get(), output);
		this.archeology(Items.RABBIT_FOOT, RatlantisItemRegistry.FERAL_RAT_CLAW.get(), output);
		this.archeology(Items.FIRE_CHARGE, RatlantisItemRegistry.CHEESE_CANNONBALL.get(), output);
		this.archeology(Items.IRON_SWORD, RatlantisItemRegistry.PIRAT_CUTLASS.get(), output);
		this.archeology(Items.PHANTOM_MEMBRANE, RatlantisItemRegistry.GHOST_PIRAT_ECTOPLASM.get(), output);
		this.archeology(Items.TROPICAL_FISH, RatlantisItemRegistry.RATFISH.get(), output);
		this.archeology(Items.DISPENSER, RatlantisItemRegistry.RATBOT_BARREL.get(), output);
		this.archeology(Items.NETHERITE_INGOT, RatlantisItemRegistry.ORATCHALCUM_INGOT.get(), output);
		this.archeology(Items.SKELETON_SKULL, RatlantisBlockRegistry.MARBLED_CHEESE_RAT_HEAD.get(), output);
		this.archeology(Items.BLUE_ORCHID, RatlantisBlockRegistry.RATGLOVE_FLOWER.get(), output);
	}

	private void archeology(ItemLike input, ItemLike result, RecipeOutput consumer) {
		new SingleItemRecipeBuilder(RecipeCategory.MISC, ArcheologistRecipe::new, Ingredient.of(input), result, 1).unlockedBy("has_input", has(input)).save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "archeologist/" + BuiltInRegistries.ITEM.getKey(result.asItem()).getPath()));
	}

	private void ratlantisStonecuttingRecipe(RecipeOutput recipe, Ingredient input, ItemLike output, String name) {
		this.ratlantisStonecuttingRecipe(recipe, input, output, 1, name);
	}

	private void ratlantisStonecuttingRecipe(RecipeOutput recipe, Ingredient input, ItemLike output, int count, String name) {
