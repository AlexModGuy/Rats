...
public class RatlantisAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {
	...
	private static AdvancementHolder createHolder(ResourceLocation id) {
	...
	private void registerRatlantisAdvancements(Consumer<AdvancementHolder> consumer) {
		Advancement.Builder.advancement().parent(createHolder(ResourceLocation.parse("rats:rat_upgrade_god"))).display(
		...
		AdvancementHolder token = Advancement.Builder.advancement().parent(root).display(
		...
		AdvancementHolder portal = Advancement.Builder.advancement().parent(token).display(
		...
		AdvancementHolder pirat = Advancement.Builder.advancement().parent(portal).display(
				...
				.addCriterion("hurt_pirat", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(Optional.of(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.PIRAT.get()).build())))
				.addCriterion("killed_pirat", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.PIRAT.get())))
				...
				.addCriterion("killed_by_pirat", KilledTrigger.TriggerInstance.entityKilledPlayer(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.PIRAT.get())))
				.save(consumer, "ratlantis:pirat");

		AdvancementHolder ghost_pirat = Advancement.Builder.advancement().parent(pirat).display(
						...
						null, AdvancementType.GOAL, true, false, false)
				.requirements(AdvancementRequirements.Strategy.OR)
				.addCriterion("hurt_ghost_pirat", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(Optional.of(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.GHOST_PIRAT.get()).build())))
				.addCriterion("killed_ghost_pirat", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.GHOST_PIRAT.get())))
				...
				.addCriterion("killed_by_ghost_pirat", KilledTrigger.TriggerInstance.entityKilledPlayer(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.GHOST_PIRAT.get())))
		...
		AdvancementHolder petals = Advancement.Builder.advancement().parent(portal).display(
		...
		AdvancementHolder gem = Advancement.Builder.advancement().parent(petals).display(
		...
		AdvancementHolder core = Advancement.Builder.advancement().parent(gem).display(
		...
		AdvancementHolder automaton = Advancement.Builder.advancement().parent(core).display(
		...
		AdvancementHolder ingot = Advancement.Builder.advancement().parent(gem).display(
		...
		AdvancementHolder ratbot = Advancement.Builder.advancement().parent(portal).display(
						...
						null, AdvancementType.TASK, true, false, false)
				.requirements(AdvancementRequirements.Strategy.OR)
				.addCriterion("hurt_ratlantean_ratbot", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(Optional.of(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_RATBOT.get()).build())))
				.addCriterion("killed_ratlantean_ratbot", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_RATBOT.get())))
				...
				.addCriterion("killed_by_ratlantean_ratbot", KilledTrigger.TriggerInstance.entityKilledPlayer(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_RATBOT.get())))
		...
		Advancement.Builder.advancement().parent(portal).display(
						...
						null, AdvancementType.TASK, true, false, false)
				.requirements(AdvancementRequirements.Strategy.OR)
				.addCriterion("hurt_ratlantean_spirit", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(Optional.of(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_SPIRIT.get()).build())))
				.addCriterion("killed_ratlantean_spirit", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_SPIRIT.get())))
				...
				.addCriterion("killed_by_ratlantean_spirit", KilledTrigger.TriggerInstance.entityKilledPlayer(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.RATLANTEAN_SPIRIT.get())))
				.save(consumer, "ratlantis:ratlantean_spirit");

		AdvancementHolder ratlantean = Advancement.Builder.advancement().parent(portal).display(
						...
						null, AdvancementType.TASK, true, false, false)
				.requirements(AdvancementRequirements.Strategy.OR)
				.addCriterion("hurt_feral_ratlantean", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntity(Optional.of(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.FERAL_RATLANTEAN.get()).build())))
				.addCriterion("killed_feral_ratlantean", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.FERAL_RATLANTEAN.get())))
				...
				.addCriterion("killed_by_feral_ratlantean", KilledTrigger.TriggerInstance.entityKilledPlayer(EntityPredicate.Builder.entity().of(RatlantisEntityRegistry.FERAL_RATLANTEAN.get())))
				.save(consumer, "ratlantis:feral_ratlantean");

		AdvancementHolder vial = Advancement.Builder.advancement().parent(ratlantean).display(
		...
		AdvancementHolder neo = Advancement.Builder.advancement().parent(vial).display(
		...
		AdvancementHolder baron = Advancement.Builder.advancement().parent(portal).display(
		...
		Advancement.Builder.advancement().parent(createHolder(ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "root"))).display(
