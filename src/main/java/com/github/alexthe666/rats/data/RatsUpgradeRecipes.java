...
public class RatsUpgradeRecipes extends RecipeProvider {
	...
	protected void buildRecipes(RecipeOutput consumer) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BASIC.get(), 4)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_upgrade_from_block"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BASIC.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_JURY_RIGGED.get())
				...
				.define('S', Tags.Items.STRINGS).unlockedBy("has_string", has(Tags.Items.STRINGS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/jury_rigged_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_SPEED.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/speed_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_PLATTER.get())
				...
				.define('C', RatsItemTags.CHEESE_ITEMS).unlockedBy("has_cheese", has(RatsItemTags.CHEESE_ITEMS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/platter_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_HEALTH.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/health_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ARMOR.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/armor_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BOW.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/bow_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CROSSBOW.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.define('A', ItemTags.ARROWS).unlockedBy("has_arrow", has(ItemTags.ARROWS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/crossbow_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_DEMON.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/demon_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_STRENGTH.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/strength_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_WARRIOR.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/warrior_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_GOD.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/god_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CHEF.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/chef_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CRAFTING.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/crafting_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BLACKLIST.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/blacklist_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_WHITELIST.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/whitelist_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_REPLANTER.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/replanter_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_FLIGHT.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/flight_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_DRAGON.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/dragon_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BEE.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/bee_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_AQUATIC.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/aquatic_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ENDER.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/ender_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_LUMBERJACK.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/lumberjack_upgrade"));
...
//				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/miner_ore_upgrade"));
//
...
//				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/miner_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_QUARRY.get(), 3)
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/quarry_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_FARMER.get())
				...
				.define('S', Tags.Items.SEEDS).unlockedBy("has_seeds", has(Tags.Items.SEEDS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/farmer_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BREEDER.get())
				...
				.define('F', RatsItemRegistry.FARMER_HAT.get()).unlockedBy("has_hat", has(RatsItemRegistry.FARMER_HAT.get()))
				.define('S', Tags.Items.SEEDS).unlockedBy("has_seeds", has(Tags.Items.SEEDS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/breeder_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_FISHERMAN.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/fisherman_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_TICK_ACCELERATOR.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/tick_accelerator_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ASBESTOS.get())
				...
				.define('G', Tags.Items.GLASS_BLOCKS).unlockedBy("has_glass", has(Tags.Items.GLASS_BLOCKS))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.define('W', Items.WHITE_WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/asbestos_upgrade"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_UNDERWATER.get())
				.pattern("GGG")
				.pattern("FUF")
				.pattern("SWS")
				.define('G', Items.GRAVEL).unlockedBy("has_gravel", has(Items.GRAVEL))
				...
				.define('S', Tags.Items.SANDS).unlockedBy("has_sand", has(Tags.Items.SANDS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/underwater_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_POISON.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/poison_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_DAMAGE_PROTECTION.get())
				...
				.define('G', Items.GOLDEN_APPLE).unlockedBy("has_apple", has(Items.GOLDEN_APPLE))
				.define('W', RatsItemRegistry.FEATHERY_WING.get()).unlockedBy("has_wing", has(RatsItemRegistry.FEATHERY_WING.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/damage_protection_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ORE_DOUBLING.get())
				...
				.define('I', Tags.Items.STORAGE_BLOCKS_IRON).unlockedBy("has_iron", has(Tags.Items.STORAGE_BLOCKS_IRON))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/ore_doubling_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BASIC_ENERGY.get())
				...
				.define('G', Tags.Items.INGOTS_GOLD).unlockedBy("has_gold", has(Tags.Items.INGOTS_GOLD))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_energy_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ADVANCED_ENERGY.get())
				...
				.define('R', Tags.Items.STORAGE_BLOCKS_REDSTONE).unlockedBy("has_redstone", has(Tags.Items.STORAGE_BLOCKS_REDSTONE))
				.define('G', Tags.Items.INGOTS_GOLD).unlockedBy("has_gold", has(Tags.Items.INGOTS_GOLD))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/advanced_energy_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ELITE_ENERGY.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/elite_energy_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_EXTREME_ENERGY.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/extreme_energy_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BUCKET.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.define('G', Tags.Items.GLASS_BLOCKS).unlockedBy("has_glass", has(Tags.Items.GLASS_BLOCKS))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/bucket_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BIG_BUCKET.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/big_bucket_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_MILKER.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/milker_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_SHEARS.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/shears_upgrade"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BOTTLER.get())
				.pattern("SBS")
				.pattern("BUB")
				.pattern("SBS")
				.define('B', Tags.Items.STRINGS).unlockedBy("has_string", has(Tags.Items.STRINGS))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.define('S', Items.GLASS_BOTTLE).unlockedBy("has_bottle", has(Items.GLASS_BOTTLE))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/bottler_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ARISTOCRAT.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/aristocrat_upgrade"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_TNT.get())
				.pattern("GTG")
				.pattern("TUT")
				.pattern("GTG")
				.define('G', Tags.Items.GUNPOWDERS).unlockedBy("has_gunpowder", has(Tags.Items.GUNPOWDERS))
				.define('T', Items.TNT).unlockedBy("has_tnt", has(Items.TNT))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/tnt_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_TNT_SURVIVOR.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/tnt_survivor_upgrade"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_PLACER.get())
				.pattern("DCD")
				.pattern("CUC")
				.pattern("DCD")
				.define('C', Items.MOSSY_COBBLESTONE).unlockedBy("has_cobble", has(Items.MOSSY_COBBLESTONE))
				.define('D', Tags.Items.DYES_PINK).unlockedBy("has_dye", has(Tags.Items.DYES_PINK))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/placer_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_VOODOO.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/voodoo_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_PICKPOCKET.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/pickpocket_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_GARDENER.get())
				...
				.define('S', Tags.Items.SEEDS).unlockedBy("has_seeds", has(Tags.Items.SEEDS))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/gardener_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_IDOL.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/idol_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_SCULKED.get())
				...
				.define('P', RatsItemRegistry.RAT_PAW.get()).unlockedBy("has_paw", has(RatsItemRegistry.RAT_PAW.get()))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/sculked_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_TIME_MANIPULATOR.get())
				...
				.define('C', RatsItemRegistry.CHARGED_CREEPER_CHUNK.get()).unlockedBy("has_chunk", has(RatsItemRegistry.CHARGED_CREEPER_CHUNK.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/time_manipulator_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ENCHANTER.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/enchanter_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_DISENCHANTER.get())
				...
				.define('F', Tags.Items.STONES).unlockedBy("has_shelf", has(Tags.Items.STONES))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.define('G', Items.GRINDSTONE).unlockedBy("has_grindstone", has(Items.GRINDSTONE))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/disenchanter_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CHRISTMAS.get())
				...
				.define('C', ItemTags.COALS).unlockedBy("has_coal", has(ItemTags.COALS))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/christmas_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_NO_FLUTE.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/flute_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_MOB_FILTER.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/filter_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_DJ.get())
				...
				.pattern("PDP")
				.define('P', ItemTags.PLANKS).unlockedBy("has_planks", has(ItemTags.PLANKS))
				.define('M', Items.MUSIC_DISC_CAT).unlockedBy("has_disc", has(Items.MUSIC_DISC_CAT))
				.define('D', Tags.Items.GEMS_DIAMOND).unlockedBy("has_diamond", has(Tags.Items.GEMS_DIAMOND))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/dj_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_SUPPORT.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/support_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_REMEDY.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/remedy_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CARRAT.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/carrat_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_ANGEL.get())
				...
				.define('W', RatsItemRegistry.FEATHERY_WING.get()).unlockedBy("has_wing", has(RatsItemRegistry.FEATHERY_WING.get()))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/angel_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_UNDEAD.get())
				...
				.define('S', RatsItemRegistry.RAT_SKULL.get()).unlockedBy("has_skull", has(RatsItemRegistry.RAT_SKULL.get()))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/undead_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/basic_mount_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_CHICKEN_MOUNT.get())
				...
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/chicken_mount_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_GOLEM_MOUNT.get())
				...
				.define('E', Tags.Items.STORAGE_BLOCKS_EMERALD).unlockedBy("has_emerald", has(Tags.Items.STORAGE_BLOCKS_EMERALD))
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/golem_mount_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_STRIDER_MOUNT.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/strider_mount_upgrade"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RatsItemRegistry.RAT_UPGRADE_BEAST_MOUNT.get())
				...
				.define('U', RatsItemRegistry.RAT_UPGRADE_BASIC_MOUNT.get()).unlockedBy("has_upgrade", has(RatsItemRegistry.RAT_UPGRADE_BASIC.get()))
				.save(consumer, ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "upgrades/beast_mount_upgrade"));
	}
}
