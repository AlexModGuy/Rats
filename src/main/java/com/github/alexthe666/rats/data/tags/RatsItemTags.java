...
public class RatsItemTags extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(HIDES_RAT_WHISKERS).add(
				Items.CREEPER_HEAD, Items.ZOMBIE_HEAD, Items.SKELETON_SKULL, Items.WITHER_SKELETON_SKULL,
				Items.PLAYER_HEAD, Items.DRAGON_HEAD, Items.PIGLIN_HEAD,
		...
		this.tag(Tags.Items.MUSIC_DISCS).add(RatsItemRegistry.MUSIC_DISC_MICE_ON_VENUS.get(), RatsItemRegistry.MUSIC_DISC_LIVING_MICE.get());
