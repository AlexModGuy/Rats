...
public class BlockModelGenerator extends BlockStateProvider {
	...
	protected void registerStatesAndModels() {
		this.builtinEntity(RatsBlockRegistry.AUTO_CURDLER.get(), Objects.requireNonNull(ResourceLocation.parse("minecraft:block/cauldron_side")));
		...
		this.simpleBlock(RatsBlockRegistry.CHEESE_CAULDRON.get(), this.models().withExistingParent("cauldron_cheese", ResourceLocation.fromNamespaceAndPath(RatsMod.MODID, "block/template_cauldron_with_transforms"))
				.texture("bottom", ResourceLocation.withDefaultNamespace("block/cauldron_bottom"))
				.texture("content", this.blockPrefix("block_of_cheese"))
				.texture("inside", ResourceLocation.withDefaultNamespace("block/cauldron_inner"))
				.texture("particle", ResourceLocation.withDefaultNamespace("block/cauldron_side"))
				.texture("side", ResourceLocation.withDefaultNamespace("block/cauldron_side"))
				.texture("top", ResourceLocation.withDefaultNamespace("block/cauldron_top")));
		...
		this.simpleBlock(RatsBlockRegistry.FISH_BARREL.get(), this.models().cube("fish_barrel",
						ResourceLocation.withDefaultNamespace("block/barrel_bottom"), this.blockPrefix("fish_barrel_top"),
						ResourceLocation.withDefaultNamespace("block/barrel_side"), ResourceLocation.withDefaultNamespace("block/barrel_side"),
						ResourceLocation.withDefaultNamespace("block/barrel_side"), ResourceLocation.withDefaultNamespace("block/barrel_side"))
				.texture("particle", ResourceLocation.withDefaultNamespace("block/barrel_side")));
		...
		this.builtinEntity(RatsBlockRegistry.RAT_HOLE.get(), Objects.requireNonNull(ResourceLocation.parse("minecraft:block/oak_planks")));
		...
		this.simpleBlock(RatsBlockRegistry.RAT_TRAP.get(), this.models().getExistingFile(ResourceLocation.withDefaultNamespace("block/oak_planks")));
		...
		this.simpleBlock(RatsBlockRegistry.TRASH_CAN.get(), this.models().cubeAll("trash_can", ResourceLocation.withDefaultNamespace("block/cauldron_side")));
		...
		this.simpleBlock(RatlantisBlockRegistry.CHUNKY_CHEESE_TOKEN.get(), this.models().cubeAll("chunky_cheese_token", this.itemPrefix("chunky_cheese_token")).renderType("minecraft:cutout"));
		...
		this.getVariantBuilder(RatlantisBlockRegistry.DUTCHRAT_BELL.get()).forAllStates(state -> {
			ModelFile type = switch (state.getValue(DutchratBellBlock.ATTACHMENT)) {
				case FLOOR ->
						this.models().withExistingParent("dutchrat_bell_floor", ResourceLocation.withDefaultNamespace("block/bell_floor")).renderType("minecraft:translucent")
								.texture("particle", this.blockPrefix("pirat_log"))
								.texture("bar", this.blockPrefix("pirat_log"))
								.texture("post", this.blockPrefix("pirat_log"));
				case CEILING ->
						this.models().withExistingParent("dutchrat_bell_ceiling", ResourceLocation.withDefaultNamespace("block/bell_ceiling")).renderType("minecraft:translucent")
								.texture("particle", this.blockPrefix("pirat_log"))
								.texture("bar", this.blockPrefix("pirat_log"));
				case SINGLE_WALL ->
						this.models().withExistingParent("dutchrat_bell_wall", ResourceLocation.withDefaultNamespace("block/bell_wall")).renderType("minecraft:translucent")
								.texture("particle", this.blockPrefix("pirat_log"))
								.texture("bar", this.blockPrefix("pirat_log"));
				case DOUBLE_WALL ->
						this.models().withExistingParent("dutchrat_bell_between_walls", ResourceLocation.withDefaultNamespace("block/bell_between_walls")).renderType("minecraft:translucent")
								.texture("particle", this.blockPrefix("pirat_log"))
								.texture("bar", this.blockPrefix("pirat_log"));
			};
		...
		this.simpleBlock(RatlantisBlockRegistry.MARBLED_CHEESE_DIRT.get(), this.models().withExistingParent("marbled_cheese_dirt", this.blockPrefix("overlay_block"))
				.texture("particle", ResourceLocation.withDefaultNamespace("block/dirt")).texture("tex", ResourceLocation.withDefaultNamespace("block/dirt"))
		...
		this.simpleBlock(RatlantisBlockRegistry.MARBLED_CHEESE_GRASS.get(), this.models().withExistingParent("marbled_cheese_grass", this.blockPrefix("grass_overlay_double"))
				.texture("particle", ResourceLocation.withDefaultNamespace("block/dirt")).texture("side", ResourceLocation.withDefaultNamespace("block/grass_block_side"))
				.texture("bottom", ResourceLocation.withDefaultNamespace("block/dirt")).texture("top", ResourceLocation.withDefaultNamespace("block/grass_block_top"))
				.texture("overlay", ResourceLocation.withDefaultNamespace("block/grass_block_side_overlay")).texture("overlay2", this.blockPrefix("marbled_cheese_overlay")));
		...
		this.simpleBlock(RatlantisBlockRegistry.PIRAT_SAPLING.get(), this.models().cross("pirat_sapling", this.blockPrefix("pirat_sapling")).renderType("minecraft:tripwire"));
		this.simpleBlock(RatlantisBlockRegistry.POTTED_PIRAT_SAPLING.get(), models().withExistingParent(RatlantisBlockRegistry.POTTED_PIRAT_SAPLING.getId().getPath(), "block/flower_pot_cross").renderType("minecraft:tripwire").texture("plant", blockTexture(RatlantisBlockRegistry.PIRAT_SAPLING.get())));
		...
		this.simpleBlock(RatlantisBlockRegistry.RATGLOVE_FLOWER.get(), this.models().cross("ratglove_flower", this.blockPrefix("ratglove_flower")).renderType("minecraft:cutout"));
		this.simpleBlock(RatlantisBlockRegistry.POTTED_RATGLOVE_FLOWER.get(), models().withExistingParent(RatlantisBlockRegistry.POTTED_RATGLOVE_FLOWER.getId().getPath(), "block/flower_pot_cross").renderType("minecraft:cutout").texture("plant", blockTexture(RatlantisBlockRegistry.RATGLOVE_FLOWER.get())));
		this.simpleBlock(RatlantisBlockRegistry.RATLANTEAN_GEM_ORE.get());
		this.simpleBlock(RatlantisBlockRegistry.RATLANTIS_PORTAL.get(), this.models().cubeAll("ratlantis_portal", ResourceLocation.withDefaultNamespace("block/yellow_stained_glass")));
