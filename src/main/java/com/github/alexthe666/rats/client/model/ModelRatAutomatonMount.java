...
public class ModelRatAutomatonMount<T extends Entity> extends AdvancedEntityModel<T> {
    ...
    public AdvancedRendererModel riderPlate;
    public AdvancedRendererModel riderPlatePivot;
    ...
    public ModelRatAutomatonMount() {
        ...
        this.riderPlatePivot = new AdvancedRendererModel(this, 34, 0);
        this.riderPlatePivot.setRotationPoint(0.0F, -15.0F, 0.0F);


        this.riderPlate = new AdvancedRendererModel(this, 34, 0);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.body.render(f5);
        this.riderPlatePivot.render(f5);
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        setRotationAngles(f, f1, f2, f3, f4, f5, (EntityRatAutomatonMount) entity);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, EntityRatAutomatonMount rat) {
