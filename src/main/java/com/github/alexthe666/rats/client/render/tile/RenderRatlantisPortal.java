...
public class RenderRatlantisPortal<T extends TileEntityRatlantisPortal> extends TileEntityRenderer<T> {
    ...
    private static final List<RenderType> RENDER_TYPES = IntStream.range(0, 16).mapToObj((p_228882_0_) -> {
        return RatsRenderType.getRatlantisPortal(p_228882_0_ + 1);
    }).collect(ImmutableList.toImmutableList());

    public RenderRatlantisPortal(TileEntityRendererDispatcher rendererDispatcherIn) {
