...
public class RenderSmallArrow extends ArrowRenderer<EntitySmallArrow> {

    public static final ResourceLocation RES_ARROW = new ResourceLocation("textures/entity/projectiles/arrow.png");

    public RenderSmallArrow() {
        super(Minecraft.getInstance().getRenderManager());
    }

    public void render(EntitySmallArrow entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
        ...
        matrixStackIn.scale(scale * 0.05625F, scale * 0.05625F, scale * 0.05625F);
        matrixStackIn.translate(-4.0D, 0.0D, 0.0D);
        IVertexBuilder vertexBuilder = bufferIn.getBuffer(RenderType.getEntityCutout(RES_ARROW)).getVertexBuilder();
    ...
    @Nullable
    @Override
    public ResourceLocation getEntityTexture(EntitySmallArrow entity) {
        return RES_ARROW;
    }
}
