...
public class ModelPartyHat extends BipedModel {
    ...
    public ModelPartyHat(float scale) {
        ...
        this.puff2 = new ModelRenderer(this, 40, 40);
        ...
        this.puff1 = new ModelRenderer(this, 40, 40);
