...
public class ModelMarbledCheeseGolem extends AdvancedModelBase {
    ...
    public AdvancedModelRenderer thruster;
    ...
    public AdvancedModelRenderer drillArm1;
    public AdvancedModelRenderer drillArm2;
    public AdvancedModelRenderer drilArm3;
    public AdvancedModelRenderer blade;
    public AdvancedModelRenderer armRight2;
    public AdvancedModelRenderer cannon;
    private ModelAnimator animator;

    public ModelMarbledCheeseGolem() {
        this.textureWidth = 128;
        this.textureHeight = 96;
        this.upperbody = new AdvancedModelRenderer(this, 0, 34);
        ...
        this.headBase = new AdvancedModelRenderer(this, 44, 0);
        ...
        this.ear2 = new AdvancedModelRenderer(this, 34, 0);
        ...
        this.drilArm3 = new AdvancedModelRenderer(this, 0, 0);
        ...
        this.cannon = new AdvancedModelRenderer(this, 68, 47);
        ...
        this.armRight1 = new AdvancedModelRenderer(this, 82, 0);
        ...
        this.thruster = new AdvancedModelRenderer(this, 36, 18);
        ...
        this.nose = new AdvancedModelRenderer(this, 64, 18);
        ...
        this.drillArm2 = new AdvancedModelRenderer(this, 0, 26);
        ...
        this.armLeft2 = new AdvancedModelRenderer(this, 107, 26);
        ...
        this.drillArm1 = new AdvancedModelRenderer(this, 0, 26);
        ...
        this.armLeft1 = new AdvancedModelRenderer(this, 82, 0);
        ...
        this.blade = new AdvancedModelRenderer(this, 0, 42);
        ...
        this.ear1 = new AdvancedModelRenderer(this, 34, 0);
        ...
        this.armRight2 = new AdvancedModelRenderer(this, 107, 26);
        ...
        this.snout = new AdvancedModelRenderer(this, 72, 23);
    ...
    public void bob(AdvancedModelRenderer box, float speed, float degree, float offset, float weight, boolean bounce, float f, float f1) {
