...
public class RatKingModel<T extends RatKing> extends AdvancedEntityModel<T> {
	...
	public void setupAnim(T rat, float f, float f1, float f2, float f3, float f4) {
		...
		if (rat.deathTime > 0) {
			...
			this.progressRotation(this.leftThigh, deathTime, (float) Math.toRadians(20.0D), 0.0F, (float) Math.toRadians(-60.0D), 5.0F);
			this.progressRotation(this.rightThigh, deathTime, (float) Math.toRadians(20.0D), 0.0F, (float) Math.toRadians(60.0D), 5.0F);
			this.progressRotation(this.leftFoot, deathTime, (float) Math.toRadians(20.0D), 0.0F, 0.0F, 5.0F);
			this.progressRotation(this.rightFoot, deathTime, (float) Math.toRadians(20.0D), 0.0F, 0.0F, 5.0F);
			this.progressRotation(this.leftArm, deathTime, (float) Math.toRadians(20.0D), 0.0F, (float) Math.toRadians(-60.0D), 5.0F);
			this.progressRotation(this.rightArm, deathTime, (float) Math.toRadians(20.0D), 0.0F, (float) Math.toRadians(60.0D), 5.0F);
			this.progressRotation(this.tail1, deathTime, (float) Math.toRadians(5.0D), 0.0F, 0.0F, 5.0F);
			this.progressRotation(this.tail2, deathTime, (float) Math.toRadians(5.0D), 0.0F, 0.0F, 5.0F);
		}
