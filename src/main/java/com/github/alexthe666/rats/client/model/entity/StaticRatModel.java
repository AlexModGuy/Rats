...
public class StaticRatModel<T extends Entity> extends AdvancedEntityModel<T> {
	...
	public StaticRatModel(float scale, boolean pinkie) {
		this.texWidth = 64;
		this.texHeight = 32;
		if (!pinkie) {
			...
			this.head.setTextureOffset(22, 20).addBox(-2.0F, -1.5F, -2.5F, 4, 3, 3, scale);
