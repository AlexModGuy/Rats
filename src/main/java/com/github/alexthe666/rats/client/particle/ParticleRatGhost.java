...
public class ParticleRatGhost extends SpriteTexturedParticle {
    private static final ResourceLocation TEXTURE = new ResourceLocation("rats:textures/particle/rat_ghost.png");

    public ParticleRatGhost(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float colorR, float colorG, float colorB) {
