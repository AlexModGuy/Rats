...
public class GuiRatUpgradeJuryRigged extends GuiContainer {
    ...
    public GuiRatUpgradeJuryRigged(InventoryPlayer playerInventory, InventoryRatUpgrade itemInventory) {
        super(new ContainerRatUpgradeJuryRigged(Minecraft.getMinecraft().player, playerInventory, itemInventory));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRenderer.drawString(this.itemInventory.getDisplayName().getUnformattedText().replace("[", "").replace("]", ""), 8, 6, 4210752);
