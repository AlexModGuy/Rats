...
public class GolemBeamRenderer extends EntityRenderer<GolemBeam> {
	...
	public void render(GolemBeam entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource buffer, int light) {
		...
		this.vertex(matrix4f, pose, consumer, -7, -2, -2, 0.0F, 0.15625F, -1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, -2, 2, 0.15625F, 0.15625F, -1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, 2, 2, 0.15625F, 0.3125F, -1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, 2, -2, 0.0F, 0.3125F, -1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, 2, -2, 0.0F, 0.15625F, 1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, 2, 2, 0.15625F, 0.15625F, 1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, -2, 2, 0.15625F, 0.3125F, 1, 0, 0, 240);
		this.vertex(matrix4f, pose, consumer, -7, -2, -2, 0.0F, 0.3125F, 1, 0, 0, 240);
		...
		for (int j = 0; j < 4; ++j) {
			...
			this.vertex(matrix4f, pose, consumer, -8, -2, 0, 0.0F, 0.0F, 0, 1, 0, 240);
			this.vertex(matrix4f, pose, consumer, 8, -2, 0, 0.5F, 0.0F, 0, 1, 0, 240);
			this.vertex(matrix4f, pose, consumer, 8, 2, 0, 0.5F, 0.15625F, 0, 1, 0, 240);
			this.vertex(matrix4f, pose, consumer, -8, 2, 0, 0.0F, 0.15625F, 0, 1, 0, 240);
		}
